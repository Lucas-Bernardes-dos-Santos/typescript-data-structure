...
/*
  ...
  *
*/
function testIsEmpty_DequeVazio() {
    const deque = new Deque();
...
function testIsEmpty_DequeCheio() {
    const deque = new Deque();
...
/*
  ...
  *
*/
function testSize_DequeFirstPositivo() {
    const deque = new Deque();
...
function testSize_DequeFirstNegativo() {
    const deque = new Deque();
