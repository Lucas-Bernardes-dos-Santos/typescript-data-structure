...
import { ValuePair } from "../data-structure/models/ValuePair.js"
...
/*
  ...
  * 
*/
function test_keyValues_A(): void {
  ...
  defaultEquals<ValuePair<number, string>>(arrayKeyValues[0], { key: 0, value: 'Melancia' }) === true &&
  defaultEquals<ValuePair<number, string>>(arrayKeyValues[1], { key: 1, value: 'Pera' }) === true &&
  defaultEquals<ValuePair<number, string>>(arrayKeyValues[2], { key: 2, value: 'Uva' }) === true ?
    console.log(PASSED(`\tTeste Result: Passed`)) :
    console.log(FAILED(`\tTeste Result: Failed`))
}
...
function test_keys_A(): void {
  ...
  defaultEquals<number[]>(dictionary.keys(), [0, 1, 2]) ?
    console.log(PASSED(`\tTeste Result: Passed`)) :
    console.log(FAILED(`\tTeste Result: Failed`))
}
...
function test_values_A(): void {
  ...
  defaultEquals<string[]>(dictionary.values(), ['Melancia', 'Pera', 'Uva']) ?
    console.log(PASSED(`\tTeste Result: Passed`)) :
    console.log(FAILED(`\tTeste Result: Failed`))
}
