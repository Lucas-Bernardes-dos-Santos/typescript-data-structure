...
/*
  ...
  * 
*/
function test_unio_A(): void {
  console.log(description(`Testando o método union():`))

  let set_A = new Set<string>()
  let set_B = new Set<string>()
...
/*
  ...
  *  
*/
function test_intersection_A(): void {
...
/*
  ...
  * 
*/
function test_difference_A(): void {
...
/*
  ...
  * 
*/
function test_isSubsetOf_A(): void {
...
function test_isSubsetOf_B(): void {
...
function test_isSubsetOf_C(): void {
